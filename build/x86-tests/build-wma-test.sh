...
echo "Expected log:"
echo "  [wma] decoder created fmt=wmav2 tag=0x161 44100Hz 2ch block=743 ... -> pcm s16 ..."
echo "  MADEIRA-WMA: MFT created"
echo "  MADEIRA-WMA: input type accepted (WMA V2, 44100 Hz, 2 ch, block 743)"
echo "  MADEIRA-WMA: output type accepted (16-bit PCM, 44100 Hz, 2 ch)"
