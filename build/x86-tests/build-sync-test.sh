...
echo "fastsync is OFF by default since ml962: this run exercises the pure server"
echo "path.  Add MADEIRA_FASTSYNC=1 to Documents/madeira-env.txt and run it again"
echo "to A/B the fast path; both runs must end in status=46."
