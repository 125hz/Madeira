...
int main(int argc, char **argv) {
    ...
    ios_loopback_io(c, 0, 0, EAGAIN);                 /* would-block is not logged */
...
with tempfile.TemporaryDirectory() as tmp:
    ...
    print("PASS: loopback probe logs 6 events per connection plus hard errors, skips would-block, unconnected and rollback")
